...
-- Report_Types
INSERT INTO report_types (label) VALUES
                                     ('Poor lighting'),
                                     ('Icy road'),
                                     ('Broken sidewalk'),
                                     ('Suspicious activity'),
...
-- Zones
INSERT INTO zones (name, description, geom) VALUES
...
-- Reports
INSERT INTO reports (user_id, type_id, zone_id, title, description, point, image_url, status, severity) VALUES
...
-- Votes
INSERT INTO votes (report_id, user_id, value) VALUES
                                                  (1, 3, TRUE),
                                                  (1, 4, TRUE),
                                                  (2, 5, TRUE),
                                                  (3, 2, FALSE),
